...
This book consists of notes written for STAT 4840 at Saint Louis University. The prerequisite for this class is Calculus I and II, and [STAT 3850](https://math.slu.edu/~speegled/_book).

Data for this book comes from the R package `tswrdata` which can be installed using `remotes::install_github(repo = "speegled/tswrdata")`. If you do not have `remotes` already installed, you will first need to run `library(packages)`.